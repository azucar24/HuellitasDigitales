    ...
    return Column(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
      CupertinoButton(
        ...
        onPressed: () {
          ...
          if (_lookU.compareTo(_user) == 0 &&
              _lookP.compareTo(_password) == 0) {
            final datah = DataH(
                paramU: _user,
                paramC:
                    "ede96yona@gmail.com" //Parametro establecido por defecto
                );
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => PrincipalPage(datah: datah)),
            );
            _user = "";
            _password = "";
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Column(
              ...
              children: <Widget>[
                Text(
                    "Has dejado un campo vacio, debes llenar usuario y contraseña para poder iniciar"),
                Icon(
                  Icons.warning,
                  size: 50,
                ),
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Column(
              ...
              children: <Widget>[
                Text(
                    "comprueba que los datos que has ingresado sean los correctos, recuerda que no puedes dejar espacios"),
                Icon(
                  Icons.warning,
                  size: 50,
                ),
